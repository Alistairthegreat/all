if (!window.top.location.href.startsWith("https://skybase-alpha.github.io/")) {
  ...
  function hidey() {
    ...
    var tabBar = prompt("Please select a tab disguise by typing the corresponding letter\r\nLeave blank for Google Classroom\r\nc - Google Classroom\r\ng - Google\r\nb - Blank\r\nt - Custom");
    ...
    if (1 != inFrame()) {
      ...
      a.document.documentElement.innerHTML =
        '<!DOCTYPE html><html><title>'+ tabName +'</title><link rel="icon" type="image/png" href='+ tabIcon +'><style>body {margin:0;}</style><body><iframe height="100%" width="100%" src="' +
